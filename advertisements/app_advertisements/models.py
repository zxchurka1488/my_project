...
class Advertisement(models.Model):
    ...
    created_at = models.DateField("Опубликовано", auto_now_add=True)
    ...
    def img_show(self):
        ...
        if self.image != "":
            ...
            return format_html('<img src="/media/%s" width="50" height="50" />' % (self.image))
        self.image = 'advertisements/adv1.png'
        return format_html('<img src="/media/%s" width="50" height="50" />' % (self.image))
